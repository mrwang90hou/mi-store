...
var cZB=_mz(z,'image',['mode',-1,'bindtap',6,'data-event-opts',1,'src',2,'style',3],[],e,s,gg)
_(fYB,cZB)
var h1B=_mz(z,'image',['mode',-1,'bindtap',10,'data-event-opts',1,'src',2,'style',3],[],e,s,gg)
_(fYB,h1B)
_(xWB,fYB)
_(r,xWB)
return r
...
var oFC=_n('view')
_rz(z,oFC,'class',13,oBC,xAC,gg)
var cGC=_oz(z,14,oBC,xAC,gg)
_(oFC,cGC)
_(hEC,oFC)
_(fCC,hEC)
return fCC
...
_(t7B,e8B)
var oHC=_mz(z,'swiper',['bindchange',15,'class',1,'current',2,'data-event-opts',3,'duration',4],[],e,s,gg)
var lIC=_v()
_(oHC,lIC)
var aJC=function(eLC,tKC,bMC,gg){
var xOC=_n('swiper-item')
var oPC=_mz(z,'scroll-view',['scrollY',-1,'bindscrolltolower',24,'class',1,'data-event-opts',2],[],eLC,tKC,gg)
var fQC=_v()
_(oPC,fQC)
if(_oz(z,27,eLC,tKC,gg)){fQC.wxVkey=1
var hSC=_v()
_(fQC,hSC)
var oTC=function(oVC,cUC,lWC,gg){
var tYC=_v()
_(lWC,tYC)
if(_oz(z,32,oVC,cUC,gg)){tYC.wxVkey=1
var eZC=_mz(z,'swiper-image',['bind:__l',33,'resdata',1,'vueId',2],[],oVC,cUC,gg)
_(tYC,eZC)
}
else{tYC.wxVkey=2
var b1C=_v()
_(tYC,b1C)
if(_oz(z,36,oVC,cUC,gg)){b1C.wxVkey=1
var o2C=_mz(z,'index-nav',['bind:__l',37,'resdata',1,'vueId',2],[],oVC,cUC,gg)
_(b1C,o2C)
var x3C=_mz(z,'divider',['bind:__l',40,'vueId',1],[],oVC,cUC,gg)
_(b1C,x3C)
}
else{b1C.wxVkey=2
var o4C=_v()
_(b1C,o4C)
if(_oz(z,42,oVC,cUC,gg)){o4C.wxVkey=1
var f5C=_mz(z,'three-adv',['bind:__l',43,'resdata',1,'vueId',2],[],oVC,cUC,gg)
_(o4C,f5C)
var c6C=_mz(z,'divider',['bind:__l',46,'vueId',1],[],oVC,cUC,gg)
_(o4C,c6C)
}
else{o4C.wxVkey=2
var h7C=_v()
_(o4C,h7C)
if(_oz(z,48,oVC,cUC,gg)){h7C.wxVkey=1
var o8C=_mz(z,'card',['bind:__l',49,'bodyCover',1,'headerTitle',2,'vueId',3],[],oVC,cUC,gg)
_(h7C,o8C)
}
else{h7C.wxVkey=2
var c9C=_v()
_(h7C,c9C)
if(_oz(z,53,oVC,cUC,gg)){c9C.wxVkey=1
var o0C=_n('view')
_rz(z,o0C,'class',54,oVC,cUC,gg)
var lAD=_v()
_(o0C,lAD)
var aBD=function(eDD,tCD,bED,gg){
var xGD=_mz(z,'common-list',['bind:__l',59,'index',1,'item',2,'vueId',3],[],eDD,tCD,gg)
_(bED,xGD)
return bED
}
lAD.wxXCkey=4
_2z(z,57,aBD,oVC,cUC,gg,lAD,'vlist','listindex','listindex')
_(c9C,o0C)
}
c9C.wxXCkey=1
c9C.wxXCkey=3
...
hSC.wxXCkey=4
_2z(z,30,oTC,eLC,tKC,gg,hSC,'v','i','i')
}
var cRC=_v()
_(oPC,cRC)
if(_oz(z,63,eLC,tKC,gg)){cRC.wxVkey=1
var oHD=_v()
_(cRC,oHD)
var fID=function(hKD,cJD,oLD,gg){
var oND=_v()
_(oLD,oND)
if(_oz(z,68,hKD,cJD,gg)){oND.wxVkey=1
var lOD=_mz(z,'swiper-image',['bind:__l',69,'resdata',1,'vueId',2],[],hKD,cJD,gg)
_(oND,lOD)
}
else{oND.wxVkey=2
var aPD=_v()
_(oND,aPD)
if(_oz(z,72,hKD,cJD,gg)){aPD.wxVkey=1
var tQD=_mz(z,'index-nav',['bind:__l',73,'resdata',1,'vueId',2],[],hKD,cJD,gg)
_(aPD,tQD)
var eRD=_mz(z,'divider',['bind:__l',76,'vueId',1],[],hKD,cJD,gg)
_(aPD,eRD)
}
else{aPD.wxVkey=2
var bSD=_v()
_(aPD,bSD)
if(_oz(z,78,hKD,cJD,gg)){bSD.wxVkey=1
var oTD=_mz(z,'card',['bind:__l',79,'headerTitle',1,'vueId',2,'vueSlots',3],[],hKD,cJD,gg)
var xUD=_n('view')
_rz(z,xUD,'class',83,hKD,cJD,gg)
var oVD=_v()
_(xUD,oVD)
var fWD=function(hYD,cXD,oZD,gg){
var o2D=_mz(z,'common-list',['bind:__l',88,'index',1,'item',2,'vueId',3],[],hYD,cXD,gg)
_(oZD,o2D)
return oZD
}
oVD.wxXCkey=4
_2z(z,86,fWD,hKD,cJD,gg,oVD,'vlist','listindex','listindex')
_(oTD,xUD)
_(bSD,oTD)
}
bSD.wxXCkey=1
...
oHD.wxXCkey=4
_2z(z,66,fID,eLC,tKC,gg,oHD,'v','i','i')
}
var l3D=_n('view')
_rz(z,l3D,'class',92,eLC,tKC,gg)
var a4D=_oz(z,93,eLC,tKC,gg)
_(l3D,a4D)
_(oPC,l3D)
fQC.wxXCkey=1
fQC.wxXCkey=3
...
lIC.wxXCkey=4
_2z(z,22,aJC,e,s,gg,lIC,'tab','index1','index1')
_(t7B,oHC)
_(r,t7B)
return r
}
...
setCssToHead([])();setCssToHead([[2,0]],"Some selectors are not allowed in component wxss, including tag name selectors, ID selectors, and attribute selectors.(./app.wxss:5041:1)",{path:"./app.wxss"})();

__wxAppCode__['app.wxss']=setCssToHead([[2,0]],"Some selectors are not allowed in component wxss, including tag name selectors, ID selectors, and attribute selectors.(./app.wxss:5041:1)",{path:"./app.wxss"});    
...
__wxAppCode__['pages/index/index.wxss']=setCssToHead([".",[1],"uni-tab-bar-loading { text-align: center; font-size: ",[0,28],"; color: #999; }\n.",[1],"tabitems { display: inline-block; width: ",[0,75],"; border-bottom: ",[0,5]," solid rgba(0, 0, 0, 0); }\n.",[1],"active .",[1],"tabitems { border-bottom: ",[0,5]," solid #fd6801; }\n",],undefined,{path:"./pages/index/index.wxss"});    
